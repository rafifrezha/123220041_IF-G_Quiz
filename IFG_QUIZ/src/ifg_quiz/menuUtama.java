...
class  menuUtama extends JFrame implements ActionListener{
	...
	add(Algo);
        ...
        add(submit);
        submit.setBounds(30, 500, 150, 32);
        submit.setFont (submit.getFont().deriveFont(16.0f));
        submit.addActionListener(this);
        
        add(logout);
        logout.setBounds(300, 500, 150, 32);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == submit){
            if(inputNama.getText().isEmpty() || inputNIM.getText().isEmpty()){
               ...
               JOptionPane.showMessageDialog(null,"Input Nilai Sudah ter-Submit!");
            this.dispose();
            new outputNilai(inputNama.getText(), inputNIM.getText(), nilaiTugas.getText(), nilaiQuiz.getText());
            }
